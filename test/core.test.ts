...
describe("core", () => {
  ...
  it("basic", async () => {
    ...
    const fn = async () => {
      let n = ((await fsStorage.getItem("n1")) as number) || 0;
      n++;
  ...
  it("multiple", async () => {
    ...
    const fn = async () => {
      let n2 = ((await fsStorage.getItem("n2")) as number) || 0;
      n2++;
  ...
  it("dir", async () => {
    ...
    const fn = async () => {
      let n = ((await fsStorage.getItem("n4")) as number) || 0;
      n++;
  ...
  it("stream", async () => {
    ...
    const fn = async () => {
      let n = ((await fsStorage.getItem("n5")) as number) || 0;
      n++;
